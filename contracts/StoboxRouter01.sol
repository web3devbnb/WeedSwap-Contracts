...
import './libraries/StoboxLibrary.sol';
import './interfaces/IStoboxRouter01.sol';
import './interfaces/IStoboxFactory.sol';
import './interfaces/IERC20.sol';
import './interfaces/IWETH.sol';

contract StoboxRouter01 is IStoboxRouter01 {
    ...
    function removeLiquidity(
        ...
        (uint amount0, uint amount1) = IStoboxPair(pair).burn(to);
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, StoboxLibrary.pairFor(factory, path[0], path[1]), amounts[0]);
